...
class Lavalink:
    def __init__(self):
        ...
        self.replace_password_command = 'sed -i "s|euqirnehlavalink098|$PASSWORD|" application.yml'
        self.replace_password_command_no_password = 'sed -i "s|euqirnehlavalink098|youshallnotpass|" application.yml'
